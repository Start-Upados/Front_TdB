  ...
  return (
    <>
      <header className="page-header">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Nossa Equipe:</h2>
        <p className="text-gray-300 text-lg">Conheça os talentosos desenvolvedores por trás da StartUpados()!</p>
      </header>
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto">
          ...
          {integrantes.map(i => (
            <div key={i.rm}
              ...
              <div className="flex justify-center gap-3">
                ...
                <a href={i.linkedin} target="_blank" rel="noopener noreferrer"
        ...
        <div className="bg-gray-100 rounded-2xl p-10 text-center">
          ...
          <a href="https://github.com/Start-Upados/Front_TdB" target="_blank" rel="noopener noreferrer"
