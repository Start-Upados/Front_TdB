            ...
            <tbody>
              {TOP_VOLUNTEERS.map((v) => (
                <tr key={v.rank} className="hover:bg-[rgba(0,212,170,0.025)]">
                  ...
                  <td className="px-2.5 py-[9px] border-b border-[rgba(0,212,170,0.05)] text-[12.5px] text-[#E8F4FD]">{v.name}</td>
                  <td className="px-2.5 py-[9px] border-b border-[rgba(0,212,170,0.05)] text-[11.5px] text-[#7EB3CE]">{v.city}</td>
