    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-3 mb-3.5">
        ...
        <Card title="Dentistas por região">
          <div className="h-[240px] lg:h-[210px]">
          ...
          {/* Patients summary — grid no mobile, flex-wrap no desktop */}
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:flex lg:flex-wrap gap-2 mt-3 pt-3 border-t border-[rgba(0,212,170,0.1)]">
            {REGIONS.map((r) => (
              <div
                key={r.name}
                className="lg:flex-1 lg:min-w-[90px] bg-[#0C1B2E] rounded-[8px] px-2.5 py-[7px] border-t-2"
        ...
        <div>
          ...
          <Card title="Tempo médio de permanência">
            <div className="grid grid-cols-3 gap-3 sm:gap-2 text-center py-1">
              {[
            ...
            <tbody>
              {TOP_STATES.map((s) => (
                <tr key={s.state} className="hover:bg-[rgba(0,212,170,0.025)]">
                  ...
                  <td className="px-2.5 py-[9px] border-b border-[rgba(0,212,170,0.05)] text-[12.5px] text-[#7EB3CE] whitespace-nowrap">
                    {s.dentists.toLocaleString('pt-BR')}
                  </td>
                  <td className="px-2.5 py-[9px] border-b border-[rgba(0,212,170,0.05)] w-[35%] min-w-[120px]">
                  ...
                  <td className="px-2.5 py-[9px] border-b border-[rgba(0,212,170,0.05)] text-[12.5px] font-semibold whitespace-nowrap"
