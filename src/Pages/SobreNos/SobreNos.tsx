  ...
  return (
    <>
      <header className="page-header">
        <h2 className="text-4xl md:text-5xl font-extrabold mb-4">Conheça a StartUpados():</h2>
        <p className="text-gray-300 text-lg">Inovação e tecnologia para transformar idéias em realidade.</p>
      </header>
        ...
        <div className="bg-white rounded-2xl shadow-md p-8 md:p-12 space-y-6">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Nosso ecossistema integra funcionalidades como cadastro e gestão de usuários, conexão com profissionais
              e voluntários, agendamento de serviços e um ambiente inteligente de comunicação e suporte.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1 leading-relaxed">
              ...
              <li>Empreendedorismo e protagonismo</li>
              <li>Impacto social e responsabilidade</li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-1 leading-relaxed">
              ...
              <li>Valorizar cada usuário, respeitando suas necessidades e sonhos.</li>
              <li>Evoluir constantemente com foco em qualidade e inovação.</li>
              <li>Atuar com responsabilidade social e tecnológica.</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-600 leading-relaxed">
              Acreditamos que a tecnologia só faz sentido quando está ao alcance de todos, e trabalhamos para
              transformar esse propósito em realidade diariamente.
            </p>
          </div>
