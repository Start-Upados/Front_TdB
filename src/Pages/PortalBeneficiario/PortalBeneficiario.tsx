...
const MOCK_PACIENTES: Paciente[] = [
  ...
  },
  {
    ...
    cidade:       'Curitiba, PR',
    programa:     'Dentista do Bem',
    dentista:     'Dra. Julia Lima',
    clinica:      'Clinica Sorriso',
    endereco:     'Rua XV de Novembro, 500 - Centro, Curitiba, PR',
    status:       'Em andamento',
    sessaoAtual:  1,
    totalSessoes: 3,
    procedimento: 'Ortodontia',
    proximaData:  '25/05/2025',
    proximaHora:  '10:00',
    historico: [
  ...
  },
  {
    ...
    programa:     'Apolônias do Bem',
    dentista:     'Dr. Rafael Oliveira',
    clinica:      'Clinica Sorriso BH',
    endereco:     'Av. Afonso Pena, 2000 - Centro, Belo Horizonte, MG',
    status:       'Em andamento',
    sessaoAtual:  2,
    totalSessoes: 6,
    procedimento: 'Ortodontia com Aparelho',
    proximaData:  '28/05/2025',
    proximaHora:  '16:00',
    historico: [
  ...
  {
    cpf:          '555.666.777-88',
    nome:         'Gabriel Alves Lima',
    idade:        15,
    cidade:       'Recife, PE',
    programa:     'Dentista do Bem',
    dentista:     'Dra. Patricia Nunes',
  ...
  {
    cpf:          '777.888.999-00',
    nome:         'Mateus Oliveira Pinto',
    idade:        11,
    cidade:       'Porto Alegre, RS',
    programa:     'Dentista do Bem',
    dentista:     'Dra. Fernanda Lima',
    clinica:      'Clinica Gaúcha Oral',
    endereco:     'Av. Ipiranga, 1500 - Azenha, Porto Alegre, RS',
    status:       'Ativo',
    sessaoAtual:  1,
    totalSessoes: 2,
    procedimento: 'Selante e Fluor',
    proximaData:  '27/05/2025',
    proximaHora:  '08:00',
    historico: [
  ...
  {
    cpf:          '888.999.000-11',
    nome:         'Julia Caroline Santos',
    idade:        31,
    cidade:       'Goiania, GO',
    programa:     'Apolônias do Bem',
    dentista:     'Dr. Bruno Carvalho',
